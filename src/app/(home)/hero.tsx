    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 pt-10 md:pt-16 pb-24">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-3xl sm:text-5xl md:text-6xl font-bold text-cs-foreground mb-8 leading-tight"
          >
            {hero.title}
          ...
          <motion.p
            variants={itemVariants}
            className="text-xl text-cs-foreground/80 mb-12 leading-relaxed"
          >
            {hero.description}
          </motion.p>
          ...
          >
            ...
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className="px-8 py-4 bg-cs-secondary text-white font-semibold rounded-lg border border-cs-secondary/20"
            >
              {hero.viewProjects}
            </motion.button>
          </motion.div>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                ...
                <h1 className="text-lg font-semibold text-cs-foreground mb-2">
                  {feature.title}
                </h1>
                <p className="text-cs-foreground/70">{feature.description}</p>
              </motion.div>
            ))}
          </motion.footer>
        </motion.div>
